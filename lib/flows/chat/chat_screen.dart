                ...
                if (snapshot.hasData) {
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (message.author ==
                          int.parse(snapshot.data![1] as String)) {
                        return ListTile(
                      ...
                      return ListTile(
                        ...
                        subtitle: Text("${message.date.year}-${message.date.month.toString().padLeft(2,'0')}-${message.date.day.toString().padLeft(2,'0')} ${message.date.hour.toString().padLeft(2,'0')}:${message.date.minute.toString().padLeft(2,'0')}"),
                      );
                    },
                  );
                        ...
                        IconButton(
                          onPressed: () async {
                            ...
                            if (response.statusCode == 200) {
                              setState(_controllerMessage.clear);
                            }
                          },
